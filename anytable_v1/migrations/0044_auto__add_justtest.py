...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('anytable_v1_justtest', (
            ...
            ('title', self.gf('django.db.models.fields.CharField')(blank=True, max_length=255)),
            ('file', self.gf('django.db.models.fields.files.ImageField')(null=True, blank=True, max_length=100)),
        ))
    ...
    models = {
        ...
        'anytable_v1.justtest': {
            ...
            'file': ('django.db.models.fields.files.ImageField', [], {'null': 'True', 'blank': 'True', 'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '255'})
        },
        'anytable_v1.region': {
        ...
        'anytable_v1.user': {
            ...
            'is_admin': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True', 'default': 'False'}),
