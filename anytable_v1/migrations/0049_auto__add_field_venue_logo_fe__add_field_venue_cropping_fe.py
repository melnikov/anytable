...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Venue.logo_fe'
        db.add_column('anytable_v1_venue', 'logo_fe',
                      self.gf('django.db.models.fields.files.ImageField')(null=True, blank=True, max_length=100),
                      keep_default=False)

        # Adding field 'Venue.cropping_fe'
        db.add_column('anytable_v1_venue', 'cropping_fe',
                      self.gf('django.db.models.fields.CharField')(default='', blank=True, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Venue.logo_fe'
        db.delete_column('anytable_v1_venue', 'logo_fe')

        # Deleting field 'Venue.cropping_fe'
        db.delete_column('anytable_v1_venue', 'cropping_fe')
    ...
    models = {
        ...
        'anytable_v1.venue': {
            ...
            'cropping_fe': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '255'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'logo_fe': ('django.db.models.fields.files.ImageField', [], {'null': 'True', 'blank': 'True', 'max_length': '100'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
