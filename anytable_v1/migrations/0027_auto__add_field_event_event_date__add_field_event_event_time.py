...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('anytable_v1_event', 'event_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'event.event_time'
        db.add_column('anytable_v1_event', 'event_time',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('anytable_v1_event', 'event_date')

        # Deleting field 'event.event_time'
        db.delete_column('anytable_v1_event', 'event_time')
