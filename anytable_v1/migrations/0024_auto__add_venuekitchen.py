...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'venueKitchen'
        db.create_table('anytable_v1_venuekitchen', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal('anytable_v1', ['venueKitchen'])

        # Adding M2M table for field kitchen on 'venue'
        m2m_table_name = db.shorten_name('anytable_v1_venue_kitchen')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('venue', models.ForeignKey(orm['anytable_v1.venue'], null=False)),
            ('venuekitchen', models.ForeignKey(orm['anytable_v1.venuekitchen'], null=False))
        ))
        db.create_unique(m2m_table_name, ['venue_id', 'venuekitchen_id'])


    def backwards(self, orm):
        # Deleting model 'venueKitchen'
        db.delete_table('anytable_v1_venuekitchen')

        # Removing M2M table for field kitchen on 'venue'
        db.delete_table(db.shorten_name('anytable_v1_venue_kitchen'))
