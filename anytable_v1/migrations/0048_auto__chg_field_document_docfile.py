...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('anytable_v1_document', 'docfile', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Document.docfile'
        db.alter_column('anytable_v1_document', 'docfile', self.gf('django.db.models.fields.files.FileField')(null=True, max_length=100))
