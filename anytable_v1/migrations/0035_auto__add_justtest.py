...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('anytable_v1_justtest', (
            ...
            ('record', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
    ...
    models = {
        ...
        'anytable_v1.venue': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True', 'null': 'True'}),
            'kitchen': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['anytable_v1.VenueKitchen']", 'blank': 'True', 'symmetrical': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
