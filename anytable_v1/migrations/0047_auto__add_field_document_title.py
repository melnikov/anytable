...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('anytable_v1_document', 'title',
                      self.gf('django.db.models.fields.CharField')(blank=True, max_length=25, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.title'
        db.delete_column('anytable_v1_document', 'title')
    ...
    models = {
        ...
        'anytable_v1.document': {
            ...
            'docfile': ('django.db.models.fields.files.FileField', [], {'blank': 'True', 'max_length': '100', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
