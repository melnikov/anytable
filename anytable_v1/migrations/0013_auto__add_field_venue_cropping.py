...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'venue.cropping'
        db.add_column('anytable_v1_venue', 'cropping',
                      self.gf('django.db.models.fields.CharField')(max_length=255, default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'venue.cropping'
        db.delete_column('anytable_v1_venue', 'cropping')
    ...
    models = {
        ...
        'anytable_v1.venue': {
            ...
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'photo': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['anytable_v1.photo']", 'null': 'True', 'symmetrical': 'False', 'blank': 'True'}),
