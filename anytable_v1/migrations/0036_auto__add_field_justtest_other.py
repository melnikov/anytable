...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'justTest.other'
        db.add_column('anytable_v1_justtest', 'other',
                      self.gf('django.db.models.fields.CharField')(max_length=255, blank=True, default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'justTest.other'
        db.delete_column('anytable_v1_justtest', 'other')
    ...
    models = {
        ...
        'anytable_v1.justtest': {
            ...
            'record': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'})
        },
        'anytable_v1.region': {
