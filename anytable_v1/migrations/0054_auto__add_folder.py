...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('anytable_v1_folder', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['anytable_v1.Folder'], null=True, blank=True)),
        ))
    ...
    models = {
        ...
        'anytable_v1.folder': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['anytable_v1.Folder']", 'null': 'True', 'blank': 'True'})
        },
        'anytable_v1.region': {
