...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Forums.parent'
        db.alter_column('anytable_v1_forums', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['anytable_v1.Forums'], null=True))
    ...
    models = {
        ...
        'anytable_v1.document': {
            ...
            'docfile': ('django.db.models.fields.files.ImageField', [], {'blank': 'True', 'max_length': '100', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '25', 'null': 'True'})
        },
        'anytable_v1.event': {
        ...
        'anytable_v1.forums': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['anytable_v1.Forums']", 'null': 'True'})
        },
        'anytable_v1.region': {
        ...
        'anytable_v1.venue': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'option': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['anytable_v1.VenueOptions']", 'null': 'True', 'symmetrical': 'False'}),
