...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'venueImage'
        db.create_table('anytable_v1_venueimage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(blank=True, max_length=100, null=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('venue', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['anytable_v1.venue'])),
        ))
        db.send_create_signal('anytable_v1', ['venueImage'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'venueImage'
        db.delete_table('anytable_v1_venueimage')
