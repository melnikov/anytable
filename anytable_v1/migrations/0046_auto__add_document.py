...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('anytable_v1_document', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('docfile', self.gf('django.db.models.fields.files.FileField')(blank=True, max_length=100, null=True)),
        ))
        db.send_create_signal('anytable_v1', ['Document'])


    def backwards(self, orm):
        # Deleting model 'Document'
        db.delete_table('anytable_v1_document')
