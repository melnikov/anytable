...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'photo.venue'
        db.add_column('anytable_v1_photo', 'venue',
                      self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['anytable_v1.venue']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'photo.venue'
        db.delete_column('anytable_v1_photo', 'venue_id')
