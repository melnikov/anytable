...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('anytable_v1_venue', 'twitter',
                      self.gf('django.db.models.fields.CharField')(blank=True, null=True, max_length=1024),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Venue.twitter'
        db.delete_column('anytable_v1_venue', 'twitter')
    ...
    models = {
        ...
        'anytable_v1.document': {
            ...
            'docfile': ('django.db.models.fields.files.ImageField', [], {'blank': 'True', 'null': 'True', 'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'blank': 'True', 'null': 'True', 'max_length': '25'})
        },
        'anytable_v1.event': {
        ...
        'anytable_v1.folder': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['anytable_v1.Folder']"})
        },
        'anytable_v1.region': {
        ...
        'anytable_v1.venue': {
            ...
            'twitter': ('django.db.models.fields.CharField', [], {'blank': 'True', 'null': 'True', 'max_length': '1024'}),
