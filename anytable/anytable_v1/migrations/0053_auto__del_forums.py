...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('anytable_v1_forums')


    def backwards(self, orm):
        # Adding model 'Forums'
        db.create_table('anytable_v1_forums', (
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['anytable_v1.Forums'])),
        ))
        db.send_create_signal('anytable_v1', ['Forums'])
